...
jahiaComponent(
  // This object is used to register the template in Jahia
  {
    ...
    return (
      <>
        <head>
          ...
          <AddResources
            type="css"
            resources={buildStaticUrl({ assetPath: "css/style.css" })}
          />
        ...
        <body className="is-boxed has-animations">
          ...
          <AddResources
            type={"javascript"}
            resources={buildStaticUrl({ assetPath: "javascript/main.min.js" })}
            targetTag="body"
          />
        </body>
      </>
